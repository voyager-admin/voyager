<template>
    <i :class="`h-${size} w-${size}`">
        <svg v-if="icon == 'helm'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 686 686" :class="'fill-current h-'+size+' w-' + size">
        ...
        <svg v-else-if="icon == 'bread'" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 979 894" :class="'fill-current h-'+size+' w-' + size">
        ...
        <component v-else :is="iconPath"></component>
    </i>
</template>
