...
export default {
    ...
    computed: {
        iconPath: function () {
            var name = this.studly(this.icon);

            if (!name.endsWith('Outline') && !name.endsWith('Solid')) {
                name = name + this.ucfirst(this.type);
            }
            if (icons.hasOwnProperty('Heroicons' + name)) {
                return icons['Heroicons'+name].name;
            } else {
                console.warn('Icon "'+name+'" does not exist');
            }

            return icons['HeroiconsBan' + this.ucfirst(this.type)].name;
        }
    },
};
</script>