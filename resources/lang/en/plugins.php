...
return [
    ...
    'plugin_updates'                => 'One plugin can be updated|:num plugins can be updated',
    'plugin_updates_info'           => 'The following plugins have a newer version available:',
    'plugin_updates_install'        => 'Run <code>composer update</code> to update them!',
